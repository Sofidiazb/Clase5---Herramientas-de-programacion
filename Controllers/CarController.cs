...
namespace Clase5.Controllers
{
    public class CarController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,Año,Marca,Patente,Color")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,Año,Marca,Patente")] Car car)
        {
            if (id != car.Id)
            {
                return NotFound();
